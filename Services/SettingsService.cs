...
public sealed class SettingsService
{
    ...
    public static AppSettings Clone(AppSettings settings) => new()
    {
        ...
        DefaultExportSpeed = settings.DefaultExportSpeed,
        ApplyCleanupOnExport = settings.ApplyCleanupOnExport,
        LastExportDirectory = settings.LastExportDirectory,
        EditorSidebarWidth = settings.EditorSidebarWidth,
        EditorTimelineHeight = settings.EditorTimelineHeight,
